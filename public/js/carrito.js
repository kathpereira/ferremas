...
function actualizarTotalCarrito(){
    ...
    for(var i=0; i< carritoItems.length;i++){
        ...
        // Quitamos el símbolo peso y el punto de miles para convertir el precio a número
    ...
    // Redondeamos el total a dos decimales y lo formateamos como moneda chilena
    total = Math.round(total * 100) / 100;
    var totalFormateado = new Intl.NumberFormat('es-CL', { style: 'currency', currency: 'CLP' }).format(total);

    // Actualizamos el elemento HTML con el total formateado
